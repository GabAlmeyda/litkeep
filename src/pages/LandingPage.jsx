    ...
    return (<>
        ...
        <main>
            ...
            <section className={styles.search}>
                ...
                <p>Com o LitKeep é possível ordenar por ordem alfabética, ordem crescente de nota ou agrupar entre os livros que você leu e não leu e muito mais!</p>
                ...
                <div className={styles.searchCardsWrapper}>
                    <div className={styles.cardsContainer}>
                        ...
                        <div className={`${styles.card} ${styles.alfaList}`}>
                            <p className={styles.card__text}>Ordem Alfabética</p>
                            <div className={styles.card__linesContainer}>
                                <div className={styles.linesContainer__line}></div>
                                <div className={styles.linesContainer__line}></div>
                                <div className={styles.linesContainer__line}></div>
                                <div className={styles.linesContainer__line}></div>
                                <div className={styles.linesContainer__line}></div>
                        ...
                        <div className={`${styles.card} ${styles.numericList}`}>
                            <p className={styles.card__text}>Ordem Numérica</p>
                            <div className={styles.card__linesContainer}>
                                <div className={styles.linesContainer__line}></div>
                                <div className={styles.linesContainer__line}></div>
                                <div className={styles.linesContainer__line}></div>
            ...
            <section className={styles.information}>
                ...
                <p>Saiba quantos já leu, quantos foram abandonados ou quantos ainda faltam ler, para começar o mais rápido possível</p>

                <div className={styles.cardsContainer}>

                    {/* Abandoned books card */}
                    <div className={`${styles.card} ${styles.abandonedBooks}`}>
                        <p className={styles.card__text}>Livros Abandonados:</p>
                    ...
                    <div className={`${styles.card} ${styles.unreadBooks}`}>
                        <p className={styles.card__text}>Livros Não Lidos:</p>
            ...
            <section className={styles.cta}>
                ...
                <p>Estamos esperando sua presença para tornar o site ainda melhor</p>
