 ...
 * @param {Array<bookShapeType>} props.bookArray - The array of books to be displayed in the table.
 ...
 */
function BookTable({ headings, bookArray, dataWidth = "100px", onDoubleClick }) {
