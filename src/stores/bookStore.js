...
/**
 * Zustand store for managing book-related data and operations.
 *
 * This store handles fetching, adding, deleting, updating, searching,
 * filtering and getting books. It also manages the fetch status and potential
 ...
 * - `getBookById(bookId)`: Gets a registered book in the server.
...
const useBookStore = create(
    persist((set, get) => ({
        ...
        /**
         * Returns a book in the database that matches the provided ID. If no books
         * are encountered, returns an error.
         *
         * @param {string} bookId - The book's id.
         *
         * @returns {bookShapeType} - The book that matches the provided ID.
         *
            ...
            try {
                ...
                Object.keys(filters).forEach((key) => {
                    if (!validFiltersKeys.includes(key)) {
                        throw new Error(
                            `Invalid filter criteria passed (${key}).`
                        );
                    }
                });
